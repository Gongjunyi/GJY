...
public class ContextLoaderListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        User[] users = {
                new User(1, "111@qq.com", "123456", "开到荼蘼", "user1.jpg", "江苏南京", LocalDate.of(2018, 6, 11)),
                new User(2, "222@qq.com", "123456", "小幸运", "user2.jpg", "浙江杭州", LocalDate.of(2019, 2, 18)),
                new User(3, "333@qq.com", "123456", "往后余生", "user3.jpg", "湖北武汉", LocalDate.of(2019, 8, 19))
        };
